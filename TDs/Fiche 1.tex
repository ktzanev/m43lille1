...
\begin{exo}
  ...
  On  lance un dé jusqu'à la première apparition du six. Notons:
    $$
      S_i=\{\text{Le $i$-ème lancer donne un six}\},\qquad i\in\N.
    $$
  Écrire à l'aide des événements $S_i$ et $S_i^c$ l'événement
    $$
      A=\{\text{La première apparition du six a lieu \emph{après} le 5-ème lancer}\}.
    $$
